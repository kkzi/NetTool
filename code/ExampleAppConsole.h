...
struct ExampleAppConsole
{
    ...
    {
        ImGui::SetNextWindowSize(ImVec2(ImGui::GetWindowWidth(), 300), ImGuiCond_FirstUseEver);
        if (!ImGui::Begin(title, p_open), ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoCollapse)
        {
            ImGui::End();
            return;
        }
